...
// Sugar a tope
public final class StatoscopeTestPlan<T: StoreProtocol> {
    // let sut: T
    let given: () throws -> T
...
extension StoreImplementation {
    @discardableResult
    fileprivate func when<Subscope: StoreProtocol>(childScope: Subscope,
                                                   file: StaticString = #file, line: UInt = #line,
                                                   _ whens: [Subscope.When]) throws -> Self {
        // assertNoDeepEffects(file: file, line: line)
        try whens.forEach {
...
/*
 ...
 extension Scope {
 @discardableResult
 func WITH<Subscope: StoreProtocol>(_ keyPath: KeyPath<Self, Subscope?>,
 file: StaticString = #file, line: UInt = #line,
