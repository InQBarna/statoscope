func testGrandchildFavoriteReachesRootAcrossTwoLevels() throws {
    ...
    // Three levels apart: root -> atList -> readingArticle. NewsFeedListReducer implements no
    // MiddlewareReducer at all, yet the root still intercepts this grandchild's event directly.
